...
if(isset($_POST['inscription']))
{
    if($_POST['user_mdp'] != '' && $_POST['user_mdp2'] != '' && $_POST['user_prenom'] != '' && $_POST['user_nom'] != '' && $_POST['user_email'] != '' && $_POST['user_tel'] != '' && $_POST['user_rue'] != '' && $_POST['user_cp'] != '' && $_POST['user_ville'] != '')
    {
        if($_POST['user_mdp'] == $_POST['user_mdp2'])		// Si les 2 mots de passe sont égaux
        {
			...
			{
				$c->ajouter_user($user_mdp, $_POST['user_prenom'], $_POST['user_nom'], $_POST['user_email'], $_POST['user_tel'], $_POST['user_rue'], $_POST['user_cp'], $_POST['user_ville']);
			
				// Inscription réussi
				header('Location: connexion.php');		// On est redirigé vers la page de connexion
				exit();
			}
			else
			{
